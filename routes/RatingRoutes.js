...
// ─── Asignación de Rutas al Enrutador ─────────────────────────────────────────

// POST a /ratings
router.post('/', crearCalificacion);

// GET a /ratings/doctor/:doctorId
router.get('/doctor/:doctorId', obtenerCalificacionesMedico);

// ─── Exportar el router ───────────────────────────────────────────────────────
// ¡AQUÍ ESTÁ LA MAGIA! Exportamos el router de Express en lugar de un objeto plano.
